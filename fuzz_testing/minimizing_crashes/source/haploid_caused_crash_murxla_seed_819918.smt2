...
(assert (xor (< _x3 _x2 _x5) (< 817827033174096615294886328579953094735544726 _x5)))
...
(assert (let ((_let0 (set.singleton (/ 676760653 5068240882))))(let ((_let1 (ite (= (= _let0 _let0) (distinct _x4 _x2 _x1) (xor (not (= (set.subset _let0 _let0) (> _x1 6371548911455839004210920636472475107366329192 55351583.962601334807037759818025181765 _x5))) (>= (/ 684250174 5631) 817827033174096615294886328579953094735544726 _x0 _x3))) (set.union _let0 _let0) _let0)))(let ((_let2 (+ (set.choose _let1) (set.choose _let1))))(let ((_let3 (/ _let2 _let2)))(<= _let3 _let3))))))
(assert (let ((_let0 (set.singleton (/ 676760653 5068240882))))(let ((_let1 (set.union _let0 _let0)))(let ((_let2 (ite (= (= _let0 _let0) (distinct _x4 _x2 _x1) (xor (not (= (set.subset _let0 _let0) (> _x1 6371548911455839004210920636472475107366329192 55351583.962601334807037759818025181765 _x5))) (>= (/ 684250174 5631) 817827033174096615294886328579953094735544726 _x0 _x3))) _let1 _let0)))(let ((_let3 (set.inter _let1 _let2)))(let ((_let4 (* (set.choose _let3) (/ 676760653 5068240882))))(let ((_let5 (set.insert _let4 _x5 _x2 (- (set.choose _let2)) _let3)))(let ((_let6 (* _let4 _let4)))(set.subset (set.union (set.minus (set.insert (set.choose _let1) 55351583.962601334807037759818025181765 _x0 _x5 (set.insert (/ _let6 _x2 _x0) _x4 _let6 (/ 684250174 5631) _let0)) (set.minus _let5 _let5)) _let5) _let2)))))))))
(assert (= 6371548911455839004210920636472475107366329192 _x4))
(assert (let ((_let0 (set.singleton (/ 676760653 5068240882))))(let ((_let1 (ite (= (= _let0 _let0) (distinct _x4 _x2 _x1) (xor (not (= (set.subset _let0 _let0) (> _x1 6371548911455839004210920636472475107366329192 55351583.962601334807037759818025181765 _x5))) (>= (/ 684250174 5631) 817827033174096615294886328579953094735544726 _x0 _x3))) (set.union _let0 _let0) _let0)))(let ((_let2 (+ (set.choose _let1) (set.choose _let1))))(let ((_let3 (/ _let2 _let2)))(<= _let3 _let3))))))
(check-sat)
(exit)
