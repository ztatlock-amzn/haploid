...
(assert (let ((_let0 (set.is_singleton (set.singleton (as set.universe (Set Int) )))))(let ((_let1 (set.singleton _x4)))(let ((_let2 (set.member _let1 _x3)))(let ((_let3 (set.card _x6)))(let ((_let4 (+ _x0 _let3)))(let ((_let5 (abs _let4)))(let ((_let6 (+ _let3 _let5 _let5)))(let ((_let7 (distinct _x6 _let1)))(let ((_let8 (distinct 14007031317600376899412121654789881 _let5 _let5)))(let ((_let9 (ite (and _let8 _let8 (or (forall ((_x2 (Set (Set Int) ) )) (distinct (not _let2) (set.member _x5 _x2))) _let8)) _let7 (<= _let6 _let6 _let6))))(let ((_let10 (set.inter _x3 _x3)))(let ((_let11 (set.member _let1 (set.inter _let10 _let10))))(let ((_let12 (= (xor (= _let0 _let11 _let9) _let9) _let9)))(and (xor (= (ite (ite _let12 _let7 _let9) _let11 _let12) (> (set.choose _let1) _let5) (set.is_singleton _x1) ((_ divisible 4062996900) _let4) _let2) _let2) _let0)))))))))))))))
